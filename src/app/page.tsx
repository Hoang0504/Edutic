...
export default function DashboardPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="mb-8">
        <h1 className="text-2xl font-semibold text-gray-900">Xin chào, Tên</h1>
      </div>
      ...
      <div className="mb-8 bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="text-center">
            ...
            <p className="text-2xl font-bold text-gray-900">.. ngày</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-lg font-semibold text-gray-900">null</p>
          </div>
          ...
          <div className="text-center">
            ...
            {isEditingTarget ? (
              ...
              <div className="space-y-2">
                <div className="text-sm font-medium text-gray-700 grid grid-cols-2 gap-2">
        ...
        <div className="grid grid-cols-7 gap-4 mb-6">
          {flashcardSchedule.map((item, index) => (
            <div
              key={index}
              className={`
                relative p-4 rounded-lg text-center cursor-pointer transition-all
                ${
                  item.completed
              ...
              `}
            >
              <div className="text-lg font-semibold mb-2">{item.day}</div>
      ...
      {/* Kết quả thi gần đây */}
      <div className="mb-8">
        <h2 className="text-xl font-semibold text-gray-900 mb-6 p-2 rounded-lg inline-block">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
          {recentTests.map((test) => (
            <div
              key={test.id}
              className="bg-gray-400 rounded-lg p-6 text-center text-white hover:bg-gray-500 transition-colors cursor-pointer"
            >
