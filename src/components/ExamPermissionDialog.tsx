  ...
  const requestPermissions = async () => {
    ...
    try {
      ...
      if (error.name === "NotAllowedError") {
        errorMessage =
          "Bạn đã từ chối quyền truy cập camera hoặc microphone. Vui lòng cấp quyền và thử lại.";
        ...
        errorMessage =
          error.message || "Có lỗi xảy ra khi truy cập camera và microphone.";
      }
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm text-gray-600">
                  <li className="flex items-center space-x-2">
                    ...
                    <span>
                      <strong>Camera:</strong> Phát hiện sự hiện diện của thí
                      sinh
                    </span>
                  </li>
                  <li className="flex items-center space-x-2">
                    ...
                    <span>
                      <strong>Microphone:</strong> Giám sát âm thanh xung quanh
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-sm text-amber-700">
                    <strong>Lưu ý:</strong> Cần cấp quyền cho cả camera và
                    microphone để sử dụng tính năng giám sát.
                  </p>
                </div>
              </div>
            </div>
