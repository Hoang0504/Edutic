  ...
  const skills = [
    {
      id: "listening",
      name: "Listening",
      description: "Phần nghe - được phép nói",
    },
    {
      id: "reading",
      name: "Reading",
      description: "Phần đọc - KHÔNG được nói",
    },
    {
      id: "writing",
      name: "Writing",
      description: "Phần viết - được phép nói",
    },
    {
      id: "speaking",
      name: "Speaking",
      description: "Phần nói - được phép nói",
    },
  ];
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-sm border p-6 mb-6">
          ...
          <p className="text-gray-600 mb-4">
            Test các tính năng giám sát camera và microphone cho kỳ thi trực
            tuyến
          </p>

          {/* Start button */}
          {!proctoringSystem.proctoringEnabled &&
            !proctoringSystem.showPermissionDialog && (
              <button
              ...
              {proctoringSystem.shouldShowRiskWarning() && (
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-red-600 font-medium">
                    Cảnh báo: {proctoringSystem.getViolationStats().total} vi
                    phạm
                  </span>
                </div>
              )}
          ...
          <div className="space-y-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <div className="text-sm text-gray-600">
                  Thử rời khỏi camera trong 5 giây để kích hoạt cảnh báo
                </div>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <div className="text-sm text-gray-600">
                  Chuyển sang phần "Reading" và thử nói gì đó
                </div>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <div className="text-sm text-gray-600">
                  Quan sát khung vẽ xanh xung quanh khuôn mặt và landmarks
                </div>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <div className="text-sm text-gray-600">
                  Khi có vi phạm, chọn "Tiếp tục thi" hoặc "Hủy bài thi"
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border p-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <div
                className={`font-medium ${
                  isTimerPaused ? "text-orange-600" : "text-green-600"
                }`}
              >
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <div className="font-medium text-gray-800">
                {proctoringSystem.getViolationStats().total}
              </div>
            </div>
          ...
          {proctoringSystem.violationHistory.length > 0 && (
            <div className="mt-6">
              ...
              <div className="space-y-2 max-h-32 overflow-y-auto">
                {proctoringSystem.violationHistory
                  .slice(-5)
                  .map((violation, index) => (
                    <div
