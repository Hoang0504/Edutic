...
export default function ExamsPage() {
  ...
  const currentExams = examList.slice(startIndex, startIndex + itemsPerPage);
            ...
            <div className="flex items-center gap-2">
              ...
              >
                <option value="releaseDate">
                  {t("exams.sortOptions.releaseDate", "Ngày phát hành")}
                </option>
                <option value="title">
                  {t("exams.sortOptions.title", "Tên đề thi")}
                </option>
                <option value="duration">
                  {t("exams.sortOptions.duration", "Thời gian")}
                </option>
              </select>
            </div>
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-4 mb-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-gray-600">
                      {t("exams.questionCount", "{{count}} câu", {
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-gray-600">
                      {t("exams.releaseDate", "Ngày phát hành: {{date}}", {
                        date: exam.releaseDate,
                      })}
                    </span>
                  </div>
                  <div className="flex items-center gap-2">
                    <ClockIcon className="h-4 w-4 text-gray-400" />
                    <span className="text-sm text-gray-600">
                      {t("exams.testDuration", "{{min}} phút thi", {
                        min: exam.testDuration,
                      })}
                    </span>
                  </div>
                </div>
