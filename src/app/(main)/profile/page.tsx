...
export default function ProfilePage() {
  ...
  const [activeStatsTab, setActiveStatsTab] =
    useState<StatisticsTabType>("results");
  ...
  const validateLearningSettings = (): boolean => {
    ...
    if (isNaN(learningSettings.studyTimePerDay)) {
      ...
      newErrors.studyTime =
        "Thời gian học không được vượt quá 1440 phút (24 giờ)";
    }

    if (listening === 0 && reading === 0 && speaking === 0 && writing === 0) {
      newErrors.listening =
        "Vui lòng nhập ít nhất một mục tiêu điểm số lớn hơn 0";
    }
  ...
  const validateScoreOnChange = (field: string, value: number, max: number) => {
    ...
    if (isNaN(value)) {
      newErrors[field as keyof FormErrors] = `Điểm ${
        field === "listening"
          ? "nghe"
          : field === "reading"
          ? "đọc"
            ...
            <div className="flex flex-col items-center gap-4 sm:gap-6">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-500 mt-1">
                  {personalInfo.accountType === "student"
                    ? "Học viên"
                    : "Quản trị viên"}
                </p>
              </div>
                  ...
                  <div className="space-y-6">
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                        <div className="bg-blue-50 p-4 rounded-lg text-center">
                          ...
                          <p className="text-2xl font-bold text-blue-600">
                            {learningSettings.targetScores.listening}
                          </p>
                        ...
                        <div className="bg-green-50 p-4 rounded-lg text-center">
                          ...
                          <p className="text-2xl font-bold text-green-600">
                            {learningSettings.targetScores.reading}
                          </p>
                          <p className="text-xs text-gray-500">/ 495 điểm</p>
                        </div>
                        <div className="bg-orange-50 p-4 rounded-lg text-center">
                          ...
                          <p className="text-2xl font-bold text-orange-600">
                            {learningSettings.targetScores.speaking}
                          </p>
                        ...
                        <div className="bg-purple-50 p-4 rounded-lg text-center">
                          ...
                          <p className="text-2xl font-bold text-purple-600">
                            {learningSettings.targetScores.writing}
                          </p>
                          <p className="text-xs text-gray-500">/ 200 điểm</p>
                        </div>
                      </div>
                    ...
                    <div>
                      ...
                      <p className="text-lg text-gray-900">
                        {learningSettings.studyTimePerDay} phút
                      </p>
                    </div>
                  </div>
                ) : (
                  ...
                  <div className="min-w-full">
                    <div className="grid grid-cols-6 gap-1 mb-2">
                      {[
                        ...
                        <div
                          key={index}
                          className="p-3 text-xs sm:text-sm font-medium text-gray-700 bg-gray-100 border border-gray-300 text-center"
                        >
                          {header}
                        </div>
                      ))}
                  ...
                  <button className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-green-50 border border-green-200 rounded-lg hover:bg-green-100 transition-colors">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-green-800 font-medium">
                        Tới trang thống kê độ chuyên cần
                      </span>
                    </div>
                  </button>
                </div>
