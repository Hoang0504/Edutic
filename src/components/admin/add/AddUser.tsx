...
interface AddUserProps {
  onSubmit: (e: React.FormEvent, formData: { email: string; role: string; avatarFile?: File; password_hash: string }) => void;
  onCancel: () => void;
}
...
const AddUserPage = ({ onSubmit, onCancel }: AddUserProps) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    onSubmit(e, { email, role, avatarFile, password_hash: password });
  };
